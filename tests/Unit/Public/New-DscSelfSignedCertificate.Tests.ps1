...
Describe 'Public\New-DscSelfSignedCertificate' -Tag 'WindowsOnly', 'Public' {
    BeforeAll {
        ...
        # Pass parameters needed InModuleScope
        InModuleScope -Parameters @{
            passedCertificateThumbprint = $mockCertificateThumbprint
            passedCertificateSubject = $mockCertificateSubject
        } -ScriptBlock {
            Set-StrictMode -Version 1.0

            $script:mockCertificateThumbprint = $passedCertificateThumbprint
            $script:mockCertificateSubject = $passedCertificateSubject
        }
    }
